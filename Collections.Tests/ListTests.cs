...
namespace Collections.Tests
{
    public class ListTests
    {
        ...
        [Fact]
        public void RemoveWhenIsReadOnlyShouldThrowExceptionAndDoNothing()
        {
            List<int> listTest = new List<int>();
            listTest.Add(1);
            listTest.Add(2);
            ...
            Assert.Throws<NotSupportedException>(() => listTest.Remove(1));
        ...
        [Fact]
        public void InsertWhenIsReadOnlyShouldThrowExceptionAndDoNothing()
        {
            List<int> listTest = new List<int>();
            listTest.Add(1);
            listTest.Add(2);
            ...
            Assert.Throws<NotSupportedException>(() => listTest.Insert(0, 4));
