...
namespace LINQ.Tests
{
    public class ExtensionMethodsTests
    {
        ...
        [Fact]
        public void OrderByWhenNullKeySelectorShouldThrowException()
        {
            string[] testArray = { "apricot", "orange", "banana", "mango" };
        ...
        [Fact]
        public void ThenByWhenMultipleCallsShouldReturnSubordinateOrderedSequence()
        {
            ListCollection<string[]> testList = new ListCollection<string[]>();
            ...
            OrderedEnumerable<string[], string> orderedList =
                (OrderedEnumerable<string[], string>)testList.OrderBy(
                    x => x[0],
                    Comparer<string>.Default).
                        ThenBy(
                            x => x[1],
        ...
        [Fact]
        public void ThenByWhenNullComparerShouldUseDefaultComparer()
        {
            string[] testArray = { "apricot", "orange", "banana", "mango", "apple", "grape", "strawberry" };
